...
{ ?>
    <?php foreach ($experiences as $experience) { ?>
        <?php if ($experience === $value && $value === 'EDF ENR') { ?>
            <h2 class="experiencesH2">Dessinateur de plan <a href="https://www.edfenr.com/" target="_blank">@ EDF ENR</a></h2>
        ...
        <?php } else if ($experience === $value && $value === 'C.R.V.M') { ?>
            <h2 class="experiencesH2">Designer UI / UX <a href="https://www.crvm.eu/" target="_blank">@ C.R.V.M</a></h2>
        ...
        <?php } else if ($experience === $value && $value === 'Ayctor') { ?>
            <h2 class="experiencesH2">Infographiste 3D <a href="https://ayctor.com/" target="_blank">@ Ayctor</a></h2>
        ...
        <?php } else if ($experience === $value && $value === 'Defta') { ?>
            <h2 class="experiencesH2">Opérateur CAO <a href="https://www.defta.eu/" target="_blank">@ Defta</a></h2>
